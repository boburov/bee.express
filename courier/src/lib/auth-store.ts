...
export const COURIER_ROLE_SLUG = "courier";
...
export function hasCourierRole(me: Me | null): boolean {
  return me?.type === "user" && me.role?.slug === COURIER_ROLE_SLUG;
}
